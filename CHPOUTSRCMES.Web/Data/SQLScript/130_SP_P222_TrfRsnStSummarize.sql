...
-- =============================================
CREATE PROCEDURE [dbo].[SP_P222_TrfRsnStSummarize]
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			TRANSFER_REASON_HEADER_ID, @processCode AS PROCESS_CODE, @serverCode AS SERVER_CODE, @batchId AS BATCH_ID, NULL, @user, GETDATE()
		FROM TRF_REASON_HEADER_T H
		WHERE H.TRANSFER_REASON_HEADER_ID = @trfRsnHeaderId 
		GROUP BY TRANSFER_REASON_HEADER_ID
