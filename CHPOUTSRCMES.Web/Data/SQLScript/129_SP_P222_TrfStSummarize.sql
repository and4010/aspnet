...
-- =============================================
CREATE PROCEDURE [dbo].[SP_P222_TrfStSummarize]
	@trfHeaderId BIGINT,
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			TRANSFER_HEADER_ID, TRANSFER_TYPE, @processCode AS PROCESS_CODE, @serverCode AS SERVER_CODE, @batchId AS BATCH_ID, NULL, @user, GETDATE()
		FROM TRF_HEADER_T H
		WHERE H.TRANSFER_HEADER_ID = @trfHeaderId 
		GROUP BY TRANSFER_HEADER_ID, TRANSFER_TYPE
