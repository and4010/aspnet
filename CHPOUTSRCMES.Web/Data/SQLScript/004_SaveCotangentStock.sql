...
BEGIN TRY
	...
	SELECT 
		...
		oc.INVENTORY_ITEM_ID,oc.INVENTORY_ITEM_NUMBER,ii.ITEM_DESC_TCH,ii.CATALOG_ELEM_VAL_070,oc.PAPER_TYPE,
		ii.CATALOG_ELEM_VAL_040,ii.CATALOG_ELEM_VAL_060,oc.SECONDARY_QUANTITY,oc.SPECIFICATION,ii.CATALOG_ELEM_VAL_110,
	...
	FROM @table a
	WHERE OSP_COTANGENT_T.BARCODE = a.BARCODE AND OSP_HEADER_ID = @headerId
