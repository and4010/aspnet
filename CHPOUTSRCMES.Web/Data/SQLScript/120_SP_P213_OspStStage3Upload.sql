...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			, NULL, MIN(H.ORGANIZATION_CODE), MIN(BATCH_NO), ISNULL(MIN(H.LAST_UPDATE_BY), MIN(H.CREATION_DATE))
			, NULL, NULL, NULL, NULL, NULL
			, NULL, NULL, NULL, NULL, NULL
			, NULL, NULL, NULL, NULL, NULL
			, NULL, -1, MIN(P.CREATION_DATE), -1, ISNULL(MIN(H.LAST_UPDATE_DATE), MIN(H.CREATION_DATE) )
			, -1
		FROM OSP_HEADER_T H 
		...
		GROUP BY  D.PROCESS_CODE, D.SERVER_CODE, D.BATCH_ID
		ORDER BY D.PROCESS_CODE, D.SERVER_CODE, D.BATCH_ID
