...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			, CASE MIN(I.CATALOG_ELEM_VAL_070) WHEN '捲筒' THEN MIN(P.PRIMARY_QUANTITY) - ISNULL(MIN(P.REMAINING_QUANTITY), 0) ELSE SUM(P.PRIMARY_QUANTITY) - SUM(P.REMAINING_QUANTITY) END
			...
			, dbo.ROLL_QUANTITY(MIN(I.CATALOG_ELEM_VAL_070), MIN(P.PRIMARY_QUANTITY) - ISNULL(MIN(P.REMAINING_QUANTITY), 0))
			, NULL
