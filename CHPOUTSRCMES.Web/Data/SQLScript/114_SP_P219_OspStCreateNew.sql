	...
	BEGIN TRY
		...
		BEGIN -- 檢查正常，寫入主檔
			...
			SELECT 
				...
				, SELECT TOP 1 OSP_HEADER_ID FROM OSP_HEADER_T WHERE BATCH_NO = MIN(o.ATTRIBUTE6) AS SRC_OSP_HEADER_ID, MIN(o.ATTRIBUTE6) AS SRC_BATCH_NO
