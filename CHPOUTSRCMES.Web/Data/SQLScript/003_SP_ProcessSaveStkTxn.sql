...
@StockId BIGINT,
@PRY_BEF_QTY decimal(30,10),
@PRY_AFT_QTY decimal(30,10),
@PRY_CHG_QTY decimal(30,10),
@SEC_BEF_QTY decimal(30,10),
...
SELECT T.[STOCK_ID],T.[ORGANIZATION_ID] ,T.[ORGANIZATION_CODE],[SUBINVENTORY_CODE]
        ...
        ,T.[BARCODE],PRIMARY_UOM_CODE ,@PRY_BEF_QTY,@PRY_AFT_QTY,@PRY_CHG_QTY
        ,SECONDARY_UOM_CODE ,@SEC_BEF_QTY,@SEC_CHG_QTY,@SEC_AFT_QTY,@CATEGORY
