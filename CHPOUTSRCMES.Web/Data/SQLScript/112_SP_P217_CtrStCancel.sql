...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			...
			CASE WHEN c.ATTRIBUTE1 = 'C' 
				AND o.CTR_ORG_ID IS NOT NULL 
				AND h.CTR_HEADER_ID IS NOT NULL
				THEN 'S' 
		...
		BEGIN 
			UPDATE CTR_HEADER_T SET STATUS = 2 WHERE CTR_HEADER_ID IN (SELECT DISTINCT CTR_HEADER_ID FROM @detailTable)
			...
			SELECT 
				CTR_PICKED_ID, A.CTR_HEADER_ID, A.CTR_DETAIL_ID, STOCK_ID, LOCATOR_ID
				,LOCATOR_CODE, BARCODE, INVENTORY_ITEM_ID, SHIP_ITEM_NUMBER, PAPER_TYPE
				,BASIC_WEIGHT, REAM_WEIGHT, ROLL_REAM_WT, SPECIFICATION, PACKING_TYPE
				,SHIP_MT_QTY, TRANSACTION_QUANTITY, TRANSACTION_UOM, PRIMARY_QUANTITY, PRIMARY_UOM
				,SECONDARY_QUANTITY, SECONDARY_UOM, LOT_NUMBER, THEORY_WEIGHT, ITEM_CATEGORY
			...
			INSERT INTO CTR_DETAIL_HT (
				CTR_DETAIL_ID, CTR_HEADER_ID, PROCESS_CODE, SERVER_CODE, BATCH_ID
				,BATCH_LINE_ID, HEADER_ID, LINE_ID, DETAIL_ID, LOCATOR_ID
				,LOCATOR_CODE, INVENTORY_ITEM_ID, SHIP_ITEM_NUMBER, PAPER_TYPE, BASIC_WEIGHT
				,REAM_WEIGHT, ROLL_REAM_QTY, ROLL_REAM_WT, TTL_ROLL_REAM, SPECIFICATION
				,PACKING_TYPE, SHIP_MT_QTY, TRANSACTION_QUANTITY, TRANSACTION_UOM, PRIMARY_QUANTITY
				,PRIMARY_UOM, SECONDARY_QUANTITY, SECONDARY_UOM, ITEM_CATEGORY, ATTRIBUTE1
			...
			SELECT 
				A.CTR_DETAIL_ID, A.CTR_HEADER_ID, A.PROCESS_CODE, A.SERVER_CODE, A.BATCH_ID
				,A.BATCH_LINE_ID, HEADER_ID, LINE_ID, DETAIL_ID, LOCATOR_ID
				,LOCATOR_CODE, INVENTORY_ITEM_ID, SHIP_ITEM_NUMBER, PAPER_TYPE, BASIC_WEIGHT
				,REAM_WEIGHT, ROLL_REAM_QTY, ROLL_REAM_WT, TTL_ROLL_REAM, SPECIFICATION
				,PACKING_TYPE, SHIP_MT_QTY, TRANSACTION_QUANTITY, TRANSACTION_UOM, PRIMARY_QUANTITY
				,PRIMARY_UOM, SECONDARY_QUANTITY, SECONDARY_UOM, ITEM_CATEGORY, ATTRIBUTE1
				...
				,CREATED_USER_NAME, CREATION_DATE, LAST_UPDATE_BY, LAST_UPDATE_USER_NAME, LAST_UPDATE_DATE
			FROM CTR_DETAIL_T A
			WHERE A.CTR_DETAIL_ID IN (SELECT DISTINCT CTR_DETAIL_ID FROM @detailTable)
