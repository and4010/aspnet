...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			...
			, CASE MIN(D.ITEM_CATEGORY) WHEN '捲筒' THEN MIN(P.TRANSACTION_QUANTITY) ELSE MIN(D.REQUESTED_TRANSACTION_QUANTITY) END
			, MIN(P.TRANSACTION_UOM)
			, CASE MIN(D.ITEM_CATEGORY) WHEN '捲筒' THEN MIN(P.PRIMARY_QUANTITY) ELSE MIN(D.REQUESTED_PRIMARY_QUANTITY) END
			...
			, dbo.ROLL_QUANTITY(MIN(S.ITEM_CATEGORY), MIN(D.REQUESTED_PRIMARY_QUANTITY)) AS ROLL_QUANTITY
