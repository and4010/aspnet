...
BEGIN
	...
	BEGIN TRY
		...
		, CASE MIN(I.CATALOG_ELEM_VAL_070) WHEN '平版' THEN SUM(D.SECONDARY_QUANTITY) ELSE SUM(D.PRIMARY_QUANTITY) END, MIN(D.PRIMARY_UOM)
		, SUM(D.PRIMARY_QUANTITY)
		, CASE MIN(I.CATALOG_ELEM_VAL_070) WHEN '平版' THEN MIN(D.SECONDARY_UOM) ELSE NULL END
		, CASE MIN(I.CATALOG_ELEM_VAL_070) WHEN '平版' THEN SUM(D.SECONDARY_QUANTITY) ELSE NULL END
