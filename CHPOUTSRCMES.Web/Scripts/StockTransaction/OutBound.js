...
function OutBoundInit() {
    ...
    var OutBoundDataTablesBody = $('#OutBoundDataTablesBody').DataTable({
        ...
        ajax: {
            ...
            "data": function (d) {
                ...
                d.OutSubinventoryCode = $("#ddlOutSubinventory").val();
                d.OutLocator = $("#ddlOutLocator").val();
                d.InSubinventoryCode = $("#ddlInSubinventory").val();
    ...
    $("#AutoCompleteItemNumber").autocomplete({
        source: function (request, response) {
            $.ajax({
                ...
                dataType: "json",
                data: {
                    SubinventoryCode: $("#ddlOutSubinventory").val(),
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    //    GetShipmentNumberList($('#txtShipmentNumber').val());
                    //}
                    //else if (TransactionType == "移轉編號") {
                    //    GetSubinventoryTransferNumberList($('#txtSubinventoryTransferNumber').val());
                    //}
                    //else {
    ...
    function GetStockItemData(ITEM_NO) {
        ...
        $.ajax({
            ...
            type: "post",
            data: {
                SUBINVENTORY_CODE: $('#ddlOutSubinventory').val(),
                ITEM_NO: ITEM_NO
            },
            success: function (data) {
                if (data.STATUS) {
