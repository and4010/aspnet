    ...
    public class ModelInitializer : DropCreateDatabaseIfModelChanges<MesContext>
    {
                    ...
                    try
                    {
                        ...
                        if (org == null || org.InventoryItemId <= 0)
                        {
                            ...
                            if (o != null)
                            {
                                ...
                                OrgItemRepositityory.Create(oRG_ITEMS_T, true);
                            }
        ...
        private static void ImportYszmpckq(IWorkbook book, MesContext context)
        {
            ...
            for (int i = 0; i < book.NumberOfSheets; i++)
            {
                ...
                YszmpckqTRepositiory.getContext().Configuration.AutoDetectChangesEnabled = false;
                ...
                for (int j = OrganizationId_cell.RowIndex + 1; j <= noOfRow; j++)
                {
                    try
                    {
                        ...
                        YszmpckqTRepositiory.Create(ySZMPCKQ_T, saveChanged : true);
                        //}
                    }
                    catch (Exception ex)
                    {
                ...
                YszmpckqTRepositiory.getContext().Configuration.AutoDetectChangesEnabled = true;
            }
        }
        ...
        private static void ImprotMachinePaperType(IWorkbook book, MesContext context)
        {
            ...
            for (int i = 0; i < book.NumberOfSheets; i++)
            {
                ...
                MachinePaperTypeRepositiory.getContext().Configuration.AutoDetectChangesEnabled = false;
                for (int j = OrganizationId_cell.RowIndex + 1; j <= noOfRow; j++)
                {
                    try
                    {
                ...
                MachinePaperTypeRepositiory.getContext().Configuration.AutoDetectChangesEnabled = true;
            }
        }
        ...
        private static void ImprotTransaction(IWorkbook book, MesContext context)
        {
            ...
            for (int i = 0; i < book.NumberOfSheets; i++)
            {
                ...
                TransactionTypeRepositiory.getContext().Configuration.AutoDetectChangesEnabled = false;
                ...
                TransactionTypeRepositiory.getContext().Configuration.AutoDetectChangesEnabled = true;
        ...
        private static void ImprotDelivery(MesContext context)
        {
            try
            {
                IRepository<DLV_HEADER_T> DliveryHeaderRepositiory = new GenericRepository<DLV_HEADER_T>(context);
                ...
                DliveryHeaderRepositiory.Create(mDLV_HEADER_T, true);
                //DliveryHeaderRepositiory.getContext().Configuration.AutoDetectChangesEnabled = true;

                IRepository<DLV_DETAIL_T> DliveryDetailRepositiory = new GenericRepository<DLV_DETAIL_T>(context);
                DLV_DETAIL_T mDLV_DETAIL_T = new DLV_DETAIL_T();
                mDLV_DETAIL_T.DlvDetailId = 1;
                mDLV_DETAIL_T.DlvHeaderId = 1;
                ...
                DliveryDetailRepositiory.Create(mDLV_DETAIL_T, true);
            }
            catch (Exception ex)
            {
                logger.Error(LogUtilities.BuildExceptionMessage(ex));
