...
namespace CHPOUTSRCMES.Web.ViewModels.Process
{
    public class ProcessViewModel
    {
        ...
        public ResultModel CreateProduction(string UserId, string UserName, string Production_Roll_Ream_Qty, string Production_Roll_Ream_Wt, string Cotangent, long OspDetailOutId, long OspDetailInId, long OspHeaderId)
        {
            using (var context = new MesContext())
            {
              return new ProcessUOW(context).CreateProduction(UserId, UserName, Production_Roll_Ream_Qty, Production_Roll_Ream_Wt, Cotangent, OspDetailOutId, OspDetailInId, OspHeaderId);
            }
        }
        ...
        {
            using var context = new MesContext();
            return new ProcessUOW(context).ChangeHeaderStatus(OspHeaderId, LocatorId, UserId, UserName);
        }
            ...
            public static List<CHP_PROCESS_T> Search(DataTableAjaxPostViewModel data, List<CHP_PROCESS_T> model)
            {
                ...
                if (!string.IsNullOrEmpty(search) && !string.IsNullOrWhiteSpace(search))
                {
                    ...
                    model = model.Where(p => (
                        ...
                        || (p.CuttingDateFrom != null) && (!string.IsNullOrEmpty(p.CuttingDateFrom.ToString()) && p.CuttingDateFrom.ToString().Contains(search.ToLower()))
                        || (p.CuttingDateTo != null) && (!string.IsNullOrEmpty(p.CuttingDateTo.ToString()) && p.CuttingDateTo.ToString().Contains(search.ToLower()))
                        ...
                        || (!string.IsNullOrEmpty(p.ReamWt) && p.ReamWt.ToString().ToLower().Contains(search.ToLower()))
                        ...
                        || (!string.IsNullOrEmpty(p.OspRemark) && p.OspRemark.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.PaperType) && p.PaperType.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.SelectedInventoryItemNumber) && p.SelectedInventoryItemNumber.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.Product_Item) && p.Product_Item.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.Note) && p.Note.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.Subinventory) && p.Subinventory.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.Createdby) && p.Createdby.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.Creationdate.ToString()) && p.Creationdate.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.LastUpdatedBy) && p.LastUpdatedBy.ToString().ToLower().Contains(search.ToLower()))
                        || (!string.IsNullOrEmpty(p.LocatorCode) && p.LocatorCode.ToString().ToLower().Contains(search.ToLower()))
                        || (p.Loss != null) && (!string.IsNullOrEmpty(p.Loss.ToString()) && p.Loss.ToString().ToLower().Contains(search.ToLower()))
                        ).ToList();
                }
                return model;
            }
