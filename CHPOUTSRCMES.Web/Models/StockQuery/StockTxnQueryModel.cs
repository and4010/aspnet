...
LEFT JOIN SUBINVENTORY_T B ON B.SUBINVENTORY_CODE = S.SUBINVENTORY_CODE AND B.ORGANIZATION_ID = O.ORGANIZATION_ID
LEFT JOIN SUBINVENTORY_T TB ON TB.SUBINVENTORY_CODE = S.DST_SUBINVENTORY_CODE AND TB.ORGANIZATION_ID = RO.ORGANIZATION_ID
